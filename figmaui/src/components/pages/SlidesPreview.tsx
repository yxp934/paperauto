...
const mockSlides = [
  {
    ...
    imageUrl: "https://via.placeholder.com/800x600/1a1a1a/ffffff?text=Quantum+Computing+Advances",
  },
  {
    id: 2,
    title: "Overview",
    section: "Introduction",
    imageUrl: "https://via.placeholder.com/800x600/1a1a1a/ffffff?text=Research+Overview",
  },
  {
    id: 3,
    title: "Key Concepts",
    section: "Background",
    imageUrl: "https://via.placeholder.com/800x600/1a1a1a/ffffff?text=Quantum+Mechanics",
  },
  {
    id: 4,
    title: "Methodology",
    section: "Methods",
    imageUrl: "https://via.placeholder.com/800x600/1a1a1a/ffffff?text=Experimental+Setup",
  },
  {
    id: 5,
    title: "Results",
    section: "Results",
    imageUrl: "https://via.placeholder.com/800x600/1a1a1a/ffffff?text=Data+Analysis",
  },
  {
    id: 6,
    title: "Discussion",
    section: "Discussion",
    imageUrl: "https://via.placeholder.com/800x600/1a1a1a/ffffff?text=Findings",
  },
  {
    id: 7,
    title: "Conclusions",
    section: "Conclusion",
    imageUrl: "https://via.placeholder.com/800x600/1a1a1a/ffffff?text=Key+Takeaways",
  },
  {
    id: 8,
    title: "Future Work",
    section: "Conclusion",
    imageUrl: "https://via.placeholder.com/800x600/1a1a1a/ffffff?text=Next+Steps",
  },
];
    ...
    <div className="p-8 max-w-[1400px] mx-auto">
      ...
      <Dialog open={!!selectedSlide} onOpenChange={() => setSelectedSlide(null)}>
        <DialogContent className="max-w-4xl">
          <DialogHeader>
            <DialogTitle>
              Slide {selectedSlide?.id} - {selectedSlide?.title}
            </DialogTitle>
            <DialogDescription>
              Full size preview of {selectedSlide?.section} section slide
            </DialogDescription>
          </DialogHeader>
          {selectedSlide && (
